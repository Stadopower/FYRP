...
def load_calibration(subject_id):
    raw = load_from_file(glob(f'D:/RUG/Term 2/FYRP/data/ivo_data/sub-P{subject_id}/motor-imagery-csp-{subject_id}-acquisition*.gdf')[0])
...
def load_driving(subject_id):
    try:
        fname = f"D:/RUG/Term 2/FYRP/data/ivo_data/sub-P{subject_id}/ses-S001/eeg/sub-P{subject_id}_ses-S001_task-Default_run-001_eeg.xdf"
